	...
	<div class="row ">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img1">
				...
				<div class="col-lg-2 col-md-2 hidden-sm hidden-xs o">
					<img class="img-responsive " src="<?php bloginfo('template_url'); ?>/images/o.png" alt="Tableros interactivos mexico">
				</div>
				<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 llam">
					<p class="llamada">LLAMANOS 858 630 5442</p>
					<p class="llamada">Ciudad de Mexico, Mexico</p>
				</div>
			</div>
